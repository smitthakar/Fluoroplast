  ...
  return (
    <footer className="bg-[#0A0A0A] text-white px-20 pt-[90px] pb-[-40px]">
      <div className=" flex flex-wrap justify-between gap-y-10">
        ...
        {/* Our Company */}
        <div className="w-[20%]">
          <h3 className="text-[20px] leading-[33.6px] font-2xl mb-4 font-redhat">
            Our Company
          </h3>
          ...
          <ul className="space-y-3 text-[#FFFFFF] text-sm">
            {[
              ...
              <li key={index} className="flex items-center gap-2">
                ...
                <Link
                  to={item.path}
                  className="text-[18px] leading-[28px] font-normal hover:text-[#9D0A0E] transition font-manrope"
                >
                  {item.name}
                </Link>
              </li>
        ...
        {/* Newsletter */}
        <div className="w-[25%] -mr-[15px]">
          <h3 className="text-[20px] leading-[33.6px] font-2xl mb-4 font-redhat">
            Newsletter
          </h3>
          <p className="text-[#FFFFFF] text-sm leading-relaxed text-left">
      ...
      <div className="flex justify-between items-center mt-10  pt-6 ">
        {/* Email Section */}
        {/* Email Section */}
        <div className="flex items-center text-[#FFFFFF] w-[522px] h-[36px] gap-[16px]">
        ...
        <div>
          {isChatOpen && (
            <div className="w-0 h-0 border-l-8 border-r-8 border-t-8 border-transparent border-t-red-700 -mt-2 ml-7"></div>
          )}
          <div
          ...
          >
            <img src={frame} alt="Chat" className="w-[98px] h-[78px]" />
          </div>
        </div>
        ...
        {isChatOpen && (
          <div className="fixed bottom-20 right-20 w-80 top-[90px] shadow-xl rounded-2xl overflow-hidden z-50 ">
            ...
            <div className="bg-gradient-to-r w-[450px] h-[140px] from-[#9D0A0E] to-[#F15922] text-white flex items-center justify-between px-4 ">
              <div className="flex flex-col items-center gap-1">
                <img
                  src={chatLogo}
                  alt="Fluoroplast Engineers"
                  className="w-[60px] h-[80px] mr-28"
                />
                <h2 className="text-lg font-semibold text-center ml-2">
                ...
                >
                  {msg.sender === "assistant" && (
                    <div className="flex items-start gap-2">
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="bg-red-200 text-black p-2 rounded-lg max-w-xs rounded-bl-none">
                          {msg.text}
                        </div>
                  ...
                  {msg.sender === "user" && (
                    <div className="flex flex-col items-end">
                      <div className="bg-red-600 text-white p-2 rounded-lg max-w-xs rounded-br-none">
                        {msg.text}
                      </div>
            ...
            <div className="bg-[#9D0A0E] p-3 flex items-center rounded-b-lg">
              <button className="text-white text-xl mx-2">
                <img src={emoji} alt="" className="w-[40px]" />
              </button>
              <input
                type="text"
                className="w-full bg-transparent text-white placeholder-gray-300 px-2 focus:outline-none"
                placeholder="Reply ..."
                value={input}
              ...
              <button className="text-white text-xl mx-2" onClick={sendMessage}>
      ...
      {/* Copyright Section */}
      <div className=" mt-4 text-[#FFFFFF] text-sm  border-t border-gray-700 pt-4 flex justify-between">
        <p className="w-[811px] h-[45px] text-left">
          Copyright © 2024 Fluoroplast Engineers | All Rights Reserved
        </p>
        <div className="w-[578px] text-right">
