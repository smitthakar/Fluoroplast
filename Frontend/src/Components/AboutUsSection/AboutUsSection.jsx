...
const AboutUsSection = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between bg-white w-full min-h-[900px] py-[112px] px-[144px] gap-[80px]">
      ...
      <h2 className="text-black font-[800]  text-[45px] leading-[84px] tracking-[0%]  " style={{ fontFamily: 'Red Hat Display' }}>
  Delivering Excellence
</h2>

<p className="text-[26px] text-[#070912] leading-[39px] tracking-[0%]" style={{ fontFamily: 'Red Hat Display', fontWeight: 600 }}>
...
<p className="text-[#070912] text-[16px] leading-[22.4px] tracking-[0%]" style={{ fontFamily: 'Manrope', fontWeight: 600 }}>
...
<button className="w-[180px] h-[55px] rounded-full border-transparent bg-gradient-to-r from-[#9D0A0E] to-[#F15922] text-white font-semibold ease-in-out transform flex items-center justify-center gap-2 group hover:bg-white hover:bg-none hover:text-[#9D0A0E] hover:border-2 hover:border-[#9D0A0E] mt-8">
      ...
      <div className="relative w-full lg:w-[50%] flex mt-[120px] justify-center">
        {/* Single Combined Image */}
        <div className="relative w-[190%] h-[690px]">
          <img
            src={newImage} 
