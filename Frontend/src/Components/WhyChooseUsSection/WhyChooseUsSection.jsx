...
const WhyChooseUsSection = () => {
  return (
    <div className="flex w-full h-[500px]">
      ...
      <div className="relative w-1/2 h-full bg-[#510002] text-white flex flex-col justify-center items-start 
        ...
        {/* Content */}
        <h3 className="text-white font-bold text-lg uppercase relative z-10">Why Choose Us</h3>
        <h2 className="text-white font-extrabold text-[50px] leading-[72px] tracking-[0%] font-['Red Hat Display'] w-[700px] relative z-10">
  ...
  <div className="text-left flex flex-col items-start">
    <img src={qualityIcon} alt="Quality" className="w-[70px] h-[70px]" />
    <p className="mt-2 text-lg font-medium font-['Manrope']">Quality</p>
    <span className="w-[40px] h-[2px] bg-white mt-1"></span>
  </div>
  <div className="text-left flex flex-col items-start">
    <img src={innovationIcon} alt="Innovation" className="w-[70px] h-[70px]" />
    <p className="mt-2 text-lg font-medium font-['Manrope']">Innovation</p>
    <span className="w-[40px] h-[2px] bg-white mt-1"></span>
  </div>
  <div className="text-left flex flex-col items-start">
    <img src={expertiseIcon} alt="Expertise" className="w-[70px] h-[70px]" />
    <p className="mt-2 text-lg font-medium font-['Manrope']">Expertise</p>
    <span className="w-[40px] h-[2px] bg-white mt-1"></span>
  </div>
  <div className="text-left flex flex-col items-start">
    <img src={customerFocusIcon} alt="Customer Focus" className="w-[70px] h-[70px]" />
    <p className="mt-2 text-lg font-medium font-['Manrope']">Customer Focus</p>
    <span className="w-[40px] h-[2px] bg-white mt-1"></span>
  </div>
</div>
